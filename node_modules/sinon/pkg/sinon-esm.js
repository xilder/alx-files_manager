...
function isIterable(value) {
    return !!value && typeOf$2(value.forEach) === "function";
}
...
var TYPE_MAP = {
    ...
    object: function(m, expectation) {
        ...
        array = map(Object.keys(expectation), function(key) {
            return key + ": " + valueToString$4(expectation[key]);
        });
...
function match(expectation, message) {
    ...
    if (!m.message) {
        m.message = "match(" + valueToString$4(expectation) + ")";
    }
...
match.same = function(expectation) {
    ...
    }, "same(" + valueToString$4(expectation) + ")");
};

match.in = function(arrayOfExpectations) {
    if (typeOf$2(arrayOfExpectations) !== "array") {
    ...
    }, "in(" + valueToString$4(arrayOfExpectations) + ")");
};

match.typeOf = function(type) {
    assertType(type, "string", "type");
    return match(function(actual) {
        return typeOf$2(actual) === type;
    }, 'typeOf("' + type + '")');
};
...
match.hasOwn = createPropertyMatcher(function(actual, property) {
    return hasOwnProperty$3(actual, property);
}, "hasOwn");
...
match.array.deepEquals = function(expectation) {
    return match(function(actual) {
        ...
        return (
            typeOf$2(actual) === "array" &&
            sameLength &&
            every$3(actual, function(element, index) {
                var expected = expectation[index];
                return typeOf$2(expected) === "array" &&
                    typeOf$2(element) === "array"
...
var functionName$3 = lib.functionName;
var typeOf$3 = lib.typeOf;
...
ascii.func = function (func) {
    var funcName = functionName$3(func) || "";
...
var createMatcher = samsam.createMatcher;
...
var splice = arrayProto$5.splice;
...
var match$2 = samsam.createMatcher;
var deepEqual$3 = samsam.deepEqual;
...
var callProto = {
    calledOn: function calledOn(thisValue) {
        if (match$2.isMatcher(thisValue)) {
    ...
    calledWith: function calledWith() {
        ...
        return reduce$1(
            calledWithArgs,
            function(prev, arg, i) {
                return prev && deepEqual$3(self.args[i], arg);
            },
            true
        );
    },
    ...
    calledWithMatch: function calledWithMatch() {
        ...
        return reduce$1(
            ...
            function(prev, expectation, i) {
                ...
                return prev && match$2(expectation).test(actual);
            },
            true
        );
    },
    ...
    returned: function returned(value) {
        return deepEqual$3(this.returnValue, value);
    },
    ...
    yieldToOn: function(prop, thisValue) {
        ...
        if (!yieldFn) {
            throwYieldError(
                this.proxy,
                " cannot yield to '" + valueToString$6(prop) + "' since no callback was passed.",
                args
            );
        }
...
var spyEntireObject_1 = spyEntireObject;

var hasOwnProperty$4 = lib.prototypes.object.hasOwnProperty;
...
function mirrorProperties(target, source) {
    for (var prop in source) {
        if (!hasOwnProperty$4(target, prop)) {
            target[prop] = source[prop];
        }
    }
}
...
var wrapMethod = function wrapMethod(object, property, method) {
    ...
    function checkWrappedMethod(wrappedMethod) {
        ...
        if (!isFunction(wrappedMethod)) {
            error = new TypeError(
                "Attempted to wrap " + typeof wrappedMethod + " property " + valueToString$7(property) + " as function"
            );
        } else if (wrappedMethod.restore && wrappedMethod.restore.sinon) {
            error = new TypeError("Attempted to wrap " + valueToString$7(property) + " which is already wrapped");
        } else if (wrappedMethod.calledBefore) {
            var verb = wrappedMethod.returns ? "stubbed" : "spied on";
            error = new TypeError("Attempted to wrap " + valueToString$7(property) + " which is already " + verb);
        }
    ...
    /* eslint-disable-next-line local-rules/no-prototype-methods */
    var owned = object.hasOwnProperty ? object.hasOwnProperty(property) : hasOwnProperty$4(object, property);
...
var lib_8$1 = lib$1.createPatch;
var lib_9$1 = lib$1.createTwoFilesPatch;
...
var match$3 = samsam.createMatcher;
...
var deepEqual$4 = samsam.deepEqual;
...
function spy(object, property, types) {
    ...
    if (!property && typeof object === "object") {
        return spyEntireObject_1(spy, object);
    }
...
var spyApi = {
    ...
    matches: function(args, strict) {
        ...
        if (margs.length <= args.length && deepEqual$4(slice$5(args, 0, margs.length), margs)) {
